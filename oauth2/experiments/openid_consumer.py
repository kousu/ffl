...
class OpenIDRequestHandler(BaseHTTPRequestHandler):
    ...
    def doVerify(self):
        ...
        else: #THERE'S TRY: ELSE: OMG WHY DIDN'T I KNOW THIS I'VE BEEN WRITING TRY: EXCEPT: return [tabout]
            if request is None:
                ...
                if True or request.shouldSendRedirect():
                    print("trust_root = ", trust_root)
                    ...
                    self.send_response(200) #OMG WHY
                    self.send_header('Content-type', 'text/html')
